...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Long shoot`}</title>

        <meta
          name="description"
          content="Experience the extraordinary with Long Shoot - Transforming the realm of social interaction through the immersive reality game 'Seeing of Cat'."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1534423861386-85a16f5d13fd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYW1lJTIwZGVzaWdufGVufDB8fHx8MTY5MzUyNjI0N3ww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the extraordinary with Long Shoot - Transforming the realm of social interaction through the immersive reality game 'Seeing of Cat'.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Level Designer" type="level-designer" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
